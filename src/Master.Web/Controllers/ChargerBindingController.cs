...
{
    [AbpMvcAuthorize("Menu.systemmanager.chargerbinding")]
    public class ChargerBindingController : MasterControllerBase
    {
        private readonly MatchManager _matchManager;
        public ChargerBindingController(MatchManager matchManager)
        {
