...
namespace Master.Migrations
{
    ...
    [Migration("20230417060137_Prize_Sort")]
    partial class Prize_Sort
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master.Authentication.UserSpeciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Master.Majors.Speciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Master.Matches.MatchAward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Master.Matches.MatchInstance", b =>
                {
                    ...
                    b.Property<int>("MatchInstanceDisplayMode");

                    b.Property<int>("MatchInstanceStatus");

                    b.Property<int>("MatchInstanceType");
            ...
            modelBuilder.Entity("Master.Prizes.PrizeGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Master.Projects.Project", b =>
                {
                    ...
                    b.Property<string>("Coorparation");

                    b.Property<DateTime>("CreationTime");

                    b.Property<long?>("CreatorUserId");

                    b.Property<int?>("CrossProjectId");
                    ...
                    b.Property<bool>("IsInChampionReview");

                    b.Property<bool>("IsInFinalReview");

                    b.Property<bool>("IsInInitialReview");

                    b.Property<bool>("IsOriginal");

                    b.Property<bool>("IsPreRejected");

                    b.Property<int?>("MatchAwardId");
                    ...
                    b.Property<int?>("RankChampion");

                    b.Property<int?>("RankFinal");

                    b.Property<int?>("RankInitial");

                    b.Property<int?>("RankManual");

                    b.Property<string>("ReportSN");

                    b.Property<decimal?>("ScoreChampion");

                    b.Property<decimal?>("ScoreFinal");

                    b.Property<decimal?>("ScoreInitial");

                    b.Property<decimal?>("ScoreManual");

                    b.Property<decimal?>("ScorePre");

                    b.HasKey("Id");

                    b.HasIndex("CreatorUserId");

                    b.HasIndex("CrossProjectId");

                    b.HasIndex("DesignOrganizationId");

                    b.HasIndex("MatchAwardId");
            ...
            modelBuilder.Entity("Master.Authentication.UserSpeciality", b =>
                {
                    b.HasOne("Master.Majors.Speciality", "Speciality")
                        .WithMany()
                        .HasForeignKey("SpecialityId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Master.Authentication.User", "User")
            ...
            modelBuilder.Entity("Master.Prizes.Prize", b =>
                {
                    ...
                    b.HasOne("Master.Prizes.PrizeGroup", "PrizeGroup")
                        .WithMany("Prizes")
            ...
            modelBuilder.Entity("Master.Projects.Project", b =>
                {
                    ...
                    b.HasOne("Master.Projects.Project", "CrossProject")
                        .WithMany()
                        .HasForeignKey("CrossProjectId");

                    b.HasOne("Master.Organizations.Organization", "DesignOrganization")
                        .WithMany()
                        .HasForeignKey("DesignOrganizationId");

                    b.HasOne("Master.Matches.MatchAward", "MatchAward")
                        .WithMany()
                        .HasForeignKey("MatchAwardId");
